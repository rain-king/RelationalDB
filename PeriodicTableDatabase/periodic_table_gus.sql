...
--
-- Name: elements; Type: TABLE; Schema: public; Owner: gus
--
...
ALTER TABLE public.elements OWNER TO gus;

--
-- Name: properties; Type: TABLE; Schema: public; Owner: gus
--
...
ALTER TABLE public.properties OWNER TO gus;

--
-- Data for Name: elements; Type: TABLE DATA; Schema: public; Owner: gus
--
...
--
-- Data for Name: properties; Type: TABLE DATA; Schema: public; Owner: gus
--
...
--
-- Name: elements elements_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: gus
--
...
--
-- Name: elements elements_pkey; Type: CONSTRAINT; Schema: public; Owner: gus
--
...
--
-- Name: properties properties_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: gus
--
...
--
-- Name: properties properties_pkey; Type: CONSTRAINT; Schema: public; Owner: gus
--
